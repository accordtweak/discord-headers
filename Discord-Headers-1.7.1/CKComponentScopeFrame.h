...
+ (struct CKComponentScopeFramePair)childPairForPair:(const struct CKComponentScopeFramePair *)arg1 newRoot:(id)arg2 componentClass:(Class)arg3 identifier:(id)arg4 initialStateCreator:(CDUnknownBlockType)arg5 stateUpdates:(const unordered_multimap_806dc048 *)arg6;
