...
+ (id)newWithTextAttributes:(const struct CKTextKitAttributes *)arg1 viewAttributes:(const unordered_map_f50c1a1f *)arg2 accessibilityContext:(const struct CKTextComponentAccessibilityContext *)arg3;
- (id).cxx_construct;
- (void).cxx_destruct;
