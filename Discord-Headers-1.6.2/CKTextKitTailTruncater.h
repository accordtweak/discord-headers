...
- (void).cxx_destruct;
- (void)_truncate;
- (unsigned int)_findTruncationInsertionPointAtOrBeforeCharacterIndex:(unsigned int)arg1 layoutManager:(id)arg2 textStorage:(id)arg3;
- (unsigned int)_calculateCharacterIndexBeforeTruncationMessage:(id)arg1 textStorage:(id)arg2 textContainer:(id)arg3;
