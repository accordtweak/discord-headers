...
- (void)componentScopeHandleWithIdentifier:(int)arg1 rootIdentifier:(int)arg2 didReceiveStateUpdate:(CDUnknownBlockType)arg3 tryAsynchronousUpdate:(BOOL)arg4;
- (id)scopeRoot;
- (id)model;
- (struct CGSize)size;
