...
@class CKComponent, CKComponentScopeRoot, NSAttributedString, NSCharacterSet, NSNumber, NSObject<OS_dispatch_semaphore>, NSString, UIColor, UIImage;
...
struct Discord {
    struct shared_ptr<DiscordInternal::EventLoop> _field1;
    struct unique_ptr<DiscordInternal::SocketClient, std::__1::default_delete<DiscordInternal::SocketClient>> _field2;
    struct shared_ptr<DiscordInternal::VoiceUser> _field3;
    struct unique_ptr<DiscordInternal::ProcessObserver, std::__1::default_delete<DiscordInternal::ProcessObserver>> _field4;
    struct function<void (const Discord::ConnectionInfo &, const std::__1::basic_string<char>&)> _field5;
    _Bool _field6;
    int _field7;
    int _field8;
};
...
struct MountContext {
    ...
    struct shared_ptr<CK::Component::ViewManager> _field3;
...
struct function<void (const Discord::ConnectionInfo &, const std::__1::basic_string<char>&)> {
    struct type _field1;
    struct __base<void (const Discord::ConnectionInfo &, const std::__1::basic_string<char>&)> *_field2;
};
...
struct shared_ptr<DiscordInternal::EventLoop> {
    struct EventLoop *_field1;
    struct __shared_weak_count *_field2;
};

struct shared_ptr<DiscordInternal::VoiceUser> {
    struct VoiceUser *_field1;
    struct __shared_weak_count *_field2;
};
...
struct unique_ptr<DiscordInternal::ProcessObserver, std::__1::default_delete<DiscordInternal::ProcessObserver>> {
    struct __compressed_pair<DiscordInternal::ProcessObserver *, std::__1::default_delete<DiscordInternal::ProcessObserver>> {
        struct ProcessObserver *_field1;
    } _field1;
};

struct unique_ptr<DiscordInternal::SocketClient, std::__1::default_delete<DiscordInternal::SocketClient>> {
    struct __compressed_pair<DiscordInternal::SocketClient *, std::__1::default_delete<DiscordInternal::SocketClient>> {
        struct SocketClient *_field1;
    } _field1;
};
