...
+ (id)newWithTextAttributes:(const struct CKTextKitAttributes *)arg1 viewAttributes:(const unordered_map_89cf6b77 *)arg2 accessibilityContext:(const struct CKTextComponentAccessibilityContext *)arg3;
- (id).cxx_construct;
- (void).cxx_destruct;
