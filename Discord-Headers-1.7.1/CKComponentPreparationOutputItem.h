...
- (id)init;
- (id)initWithReplacementModel:(id)arg1 lifecycleManager:(id)arg2 lifecycleManagerState:(struct CKComponentLifecycleManagerState)arg3 oldSize:(struct CGSize)arg4 UUID:(id)arg5 indexPath:(id)arg6 changeType:(unsigned long long)arg7 passthrough:(_Bool)arg8 context:(id)arg9;
