...
- (id)init;
- (id)initWithReplacementModel:(id)arg1 lifecycleManager:(id)arg2 lifecycleManagerState:(struct CKComponentLifecycleManagerState)arg3 oldSize:(struct CGSize)arg4 UUID:(id)arg5 sourceIndexPath:(id)arg6 destinationIndexPath:(id)arg7 changeType:(unsigned long long)arg8 passthrough:(_Bool)arg9 context:(id)arg10;
